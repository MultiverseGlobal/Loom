...
function ConnectPageContent() {
    ...
    const handleAuthorize = async () => {
        ...
        try {
            ...
            setTimeout(() => {
                window.location.href = `vscode://ShiftAI.shift-dev-bridge/connect?pairing_id=${session.id}`;
            }, 500);
            ...
            <div className="min-h-screen bg-[var(--bg-root)] flex items-center justify-center p-4">
                <div className="max-w-md w-full bg-[var(--bg-panel)] border border-[var(--border-subtle)] rounded-2xl p-8 text-center shadow-2xl">
                    ...
                    <p className="text-[var(--text-secondary)] mb-8">
                        Your IDE is now paired with Shift AI. You can close this tab and return to VS Code.
                    </p>
                    <button
        ...
        <div className="min-h-screen bg-[var(--bg-root)] flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-md">
                <div className="flex items-center justify-center gap-3 mb-10">
                    <ShiftLogo size={48} />
                    <span className="text-3xl font-semibold tracking-tight text-[var(--text-primary)]">Shift AI</span>
                </div>
                    ...
                    {loading ? (
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-[var(--text-secondary)] text-sm mb-8">
                                By connecting, this IDE will have access to your Shift AI projects and AI configuration.
                            </p>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-[var(--text-secondary)] text-sm mb-8">
                                Open the <strong>Shift AI</strong> extension in VS Code and click <strong>"Connect Workspace"</strong> to start the pairing process.
                            </p>
                            <button
                                onClick={() => router.push('/dashboard')}
                                className="px-6 py-2 bg-[var(--bg-subtle)] hover:bg-[var(--bg-active)] rounded-lg text-sm text-[var(--text-primary)] transition-colors"
